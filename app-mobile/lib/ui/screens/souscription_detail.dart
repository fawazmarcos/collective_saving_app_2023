...
import 'package:epargne_collective/ui/screens/historique_demande_retrait.dart';
...
class _SouscriptionDetailState extends State<SouscriptionDetail>
  ...
  demandeSubvention() async {
    ...
    if (souscription.bloque &&
      ...
      final docSubvention =
          FirebaseFirestore.instance.collection("demandes_subvention").doc();
      ...
      await docSubvention.set(jsonData).then((value) {
        //Message succès
        SnackBarSuccessWidget.show(
            context, "Demande de subvention bien effectuée");
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionBubble(
          items: <Bubble>[
            ...
            if (souscription.idTypeEpargne != null)
              Bubble(
