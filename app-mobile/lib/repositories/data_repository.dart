...
/*------- End sousciption ---------*/
  ...
  /*--- Demande retrait -----*/
  List<DemandeRetraitModel> _demandesRetraitList = [];

  List<DemandeRetraitModel> get demandesRetraitList => _demandesRetraitList;

  void updateDemandesRetraitList(List<DemandeRetraitModel> demandesRetraits) {
    _demandesRetraitList = demandesRetraits;
    notifyListeners();
  }
  ...
  //Récupérer les demandes retraits
  Future<void> getDemandesRetrait() async {
    try {
      _demandesRetraitList.clear();
      var demandes = await apiservice.getDemandesRetrait();
      _demandesRetraitList.addAll(demandes);
    } catch (e) {
      print("Erreur: $e");
    }
  }
